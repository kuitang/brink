...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "llm_integration: marks tests requiring LLM API calls")
    config.addinivalue_line("markers", "e2e: marks end-to-end Playwright tests")
    config.addinivalue_line("markers", "webapp: marks webapp-specific tests")
