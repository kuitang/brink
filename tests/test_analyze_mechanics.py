...
Tests cover:
- IssueSeverity enum
- Issue and AnalysisReport dataclasses
...
class TestIssue:
    ...
    def test_issue_creation(self):
        ...
        assert issue.metric == "test_metric"
        assert issue.value == 0.75
        assert issue.threshold == 0.60
    ...
    def test_issue_to_dict(self):
        ...
        assert data["metric"] == "variance"
        assert data["value"] == 45.0
        assert data["threshold"] == 40.0


# =============================================================================
# AnalysisReport Dataclass Tests
# =============================================================================
...
class TestAnalysisReport:
    ...
    def test_default_values(self):
        """Test default AnalysisReport values."""
        report = AnalysisReport()
        assert report.passed is True
        assert len(report.issues) == 0
        assert len(report.summary) == 0

    def test_add_issue_non_critical(self):
        """Test adding a non-critical issue keeps passed=True."""
        report = AnalysisReport()
        report.add_issue(
            severity="minor",
            message="Minor issue",
    ...
    def test_add_issue_critical_sets_failed(self):
        """Test adding a critical issue sets passed=False."""
        report = AnalysisReport()
        report.add_issue(
            severity="critical",
    ...
    def test_to_dict(self):
        ...
        report = AnalysisReport()
        report.summary = {"total_games": 100}
        report.add_issue(
            severity="major",
            message="Test",
            metric="variance",
...
class TestDefaultThresholds:
    ...
    def test_dominant_strategy_threshold(self):
        """Test dominant strategy threshold is 60%."""
        assert DEFAULT_THRESHOLDS["dominant_strategy"] == 0.60

    def test_variance_range(self):
        """Test variance thresholds are 10-40."""
        assert DEFAULT_THRESHOLDS["variance_min"] == 10.0
        assert DEFAULT_THRESHOLDS["variance_max"] == 40.0

    def test_settlement_rate_range(self):
        """Test settlement rate thresholds are 30-70%."""
        assert DEFAULT_THRESHOLDS["settlement_rate_min"] == 0.30
        assert DEFAULT_THRESHOLDS["settlement_rate_max"] == 0.70

    def test_game_length_range(self):
        """Test game length thresholds are 8-16."""
        assert DEFAULT_THRESHOLDS["avg_game_length_min"] == 8.0
        assert DEFAULT_THRESHOLDS["avg_game_length_max"] == 16.0


# =============================================================================
# compute_summary_from_results Tests
# =============================================================================
